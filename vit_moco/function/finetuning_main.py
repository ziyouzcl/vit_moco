...
# vit_moco.lib.utils：set_seed / dist_setup / get_conf（base、distributed、config_parser）
from vit_moco.lib.utils import set_seed, dist_setup, get_conf
# vit_moco.lib.trainers（经 lib/trainers/__init__.py 再导出）:
#   MoCo3DTrainer <- lib/trainers/moco3d_trainer.py
#   ViT3DTrainer  <- lib/trainers/vit3d_trainer.py
# main_worker 里用 getattr(trainers, args.trainer_name) 取具体 Trainer 类
import vit_moco.lib.trainers as trainers
